  ...
  return (
    <div className=" relative max-w-screen-4xl mx-auto p-4 md:p-6 mt-5 md:mt-20 text-white">
      ...
      <div className="flex-col items-center justify-center">
        ...
        <div className="w-full z-10 mt-10 text-center ">
          <h1 className="text-4xl font-bold">Our pricing</h1>
          <div className="md:flex justify-center  mt-10 space-x-6">
            <div className="flex border rounded-lg w-[70%] ">
              {/* Pricing Card 1 - Startup */}
              <div className="w-1/2 bg-white text-black p-4 md:p-6 rounded-l-lg  ">
              ...
              {/* Pricing Card 2 - Pro */}
              <div className="w-1/2 bg-white text-black p-6 border-l rounded-r-lg ">
            ...
            <div className="w-[30%] bg-gradient-to-r from-customLightBlue to-customBlue text-white p-6 rounded-lg shadow-lg  border border-white">
              ...
              <ul className="mt-3  text-left">
                ...
                <li className="mb-1 flex items-center gap-1 text-base ">
                  <IoIosArrowRoundForward className="text-2xl text-white" /> Up
                  to 15 developers
                </li>
                <li className="mb-1 flex items-center gap-1 text-base">
                  <IoIosArrowRoundForward className="text-2xl text-white" />
          ...
          <div className="flex flex-col  mt-6 md:mt-0">
            ...
            <ul className="mt-3">
              <li className="mb-2 flex items-center gap-2">
                <IoIosArrowRoundForward className="text-customBlue" /> All Fauna
                core capabilities
              </li>
              <li className="mb-2 flex items-center gap-2">
              ...
              <li className="mb-2 flex items-center gap-2">
                <IoIosArrowRoundForward className="text-customBlue" /> Community
                support only
              </li>
            </ul>
          </div>
